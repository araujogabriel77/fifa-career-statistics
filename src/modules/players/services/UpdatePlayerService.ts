...
import validateUpdatePlayerFields from '../utils/validateUpdatePlayerFields';
...
class UpdatePlayerService {
    ...
    public async execute({
        ...
        const validateFields = validateUpdatePlayerFields({
            name,
            country,
            position,
            first_overall,
        ...
        if (validateFields) {
            throw new AppError(validateFields);
        }
